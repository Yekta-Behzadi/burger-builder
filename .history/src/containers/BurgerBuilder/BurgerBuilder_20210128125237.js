...
import * as burgerBuilderActions from '../../store/action/actionsTypes';
...
const mapDispatchToProps = dispatch => {
  return {
    onIngredientAdded :(ingName)=> dispatch({type : burgerBuilderActions.ADD_INGREDIENT , ingredientName: ingName}),
